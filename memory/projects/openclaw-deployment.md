...
## Overview
Deploying OpenClaw as a personal assistant ("Lyra") with a Telegram bot front end, acting as a homelab manager. Provider setup uses local Ollama (qwen3:14b on the Unraid RTX 3060) with Anthropic's API available as an alternative provider.
...
- [x] Assistant identity defined (Lyra, she/her)
